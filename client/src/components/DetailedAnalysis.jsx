...
const DetailedAnalysis = ({ analysisData }) => {
    const strengths = [
        "Some level of strategic language and objective setting in place",
        "Basic technology tools and some integration present",
        "Limited culture of ownership exists with some empowerment in teams"
    ];

    const weaknesses = [
        'Lack of clear alignment and definition in product strategy',
        'Processes are inconsistently followed and lack collaboration',
        'Partially modernized technology infrastructure with limited automation',
        'Absence of a culture of ownership and empowerment among team members'
    ];

    const improvementAreas = [
        'Improved strategic alignment and definition',
        'Enhanced process consistency and cross-functional collaboration',
        'Modernization of technology infrastructure and increased automation',
        'Cultivating a culture of ownership, empowerment and customer-centric focus'
    ];
